...
class Program
{
    static void Main()
    {
        ...
        string[] makanan = { "Nasi Goreng", "Nasi Uduk", "Nasi Rames", "Soto", "Mie Goreng", "Mie Ayam" };
        double[] hargaMakanan = { 12000, 9000, 6000, 10000, 8000, 10000 };

        // Array untuk daftar minuman dan harga
        string[] minuman = { "Teh Botol", "Teh Pucuk", "Susu Jahe", "Lemon Tea", "Kopi Susu", "Jus Buah" };
        double[] hargaMinuman = { 5000, 4000, 3000, 3000, 5000, 5000 }; // 
